  ...
  return (
    <>
      <div className="rounded-xl  border-2   border-gray-950 shadow-xl shadow-gray-950 ">
        <h2 className=" text-white font-serif text-3xl tracking-wide text-center mb-8">
          Secret Santa
        </h2>
        <img
      ...
      <div className="flex flex-col  flex-wrap">
        ...
        <button className="my-6 border-2 border-black  yellowBg p-1 w-2/4 tracking-wide  font-bold rounded-md  hover:scale-110  hover:text-black  cursor-pointer  text-black shadow-md shadow-gray-950">
          <Link to="/InvisibleFriend">
            Access 
          </Link>
        </button>
        <h3 className=" greyFont text-md text-white -my-4">
