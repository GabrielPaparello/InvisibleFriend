        ...
        <form
          ...
          <input
            ...
            type="number"
              ...
              placeholder="   1...10"
            />
            <h3 className="grayText text-xs md:text-sm font-sans font-bold  tracking-wide m-2 mb-5">Inserte cantidad de jugadores</h3>
            <h2 className="text-lg md:text-2xl text-start text-nowrap -mb-4 font-sans font-semibold text-white tracking-wider ">Reglas para los jugadores</h2>
            <textarea
            ...
            type="text"
              ...
              rows="2"
            />
            <h3 className="grayText text-xs font-sans font-bold  tracking-wide m-1 md:mt-3">Configure parametros</h3>
